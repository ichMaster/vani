...
- **Storage:** local JSON behind a repository through v2 P1, MongoDB from v2 P2. The user's birth data is sensitive; store it privately.
...
- Storage of the canon, portrait, and conversation line: local JSON now, MongoDB from v2 P2.
